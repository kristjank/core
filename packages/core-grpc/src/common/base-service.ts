...
export abstract class BaseService {
    ...
    protected readonly transactionsRepository = app.resolvePlugin<Database.IDatabaseService>("database")
        .transactionsBusinessRepository;
    protected readonly blocksRepository = app.resolvePlugin<Database.IDatabaseService>("database")
